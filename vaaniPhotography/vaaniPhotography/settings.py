"""
Django settings for vaaniPhotography project.
...
SECRET_KEY = 'django-insecure-wi81vhr#f*n=q3sx5y!$c^38h!$5%!@(^6u*2sb%y6a_ydez@l'
...
ROOT_URLCONF = 'vaaniPhotography.urls'
...
WSGI_APPLICATION = 'vaaniPhotography.wsgi.application'
